...
namespace TS4.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(255, ErrorMessage = "Login must be less then 255 characters", MinimumLength = 1)]
            [Display(Name = "Login")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //await _emailStore.SetEmailAsync(user, "qwer@mail.com", CancellationToken.None);
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync("qwer@mail.com", "Confirm your email",
